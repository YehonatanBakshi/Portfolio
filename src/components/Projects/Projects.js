...
import GenericCard from "../GenericCard"; // Use GenericCard instead of ProjectCard
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "20px" }}>
          ...
          <Col md={4} className="project-card">
            <GenericCard
              imgPath={cutTheRope}
              title="Cut the Rope"
              description="This game involves strategic puzzle-solving where the player aims to deliver candy to Iggy, the character trying to save the galaxy, by cutting ropes and utilizing various elements. It features a physics-based gameplay with multiple levels, each presenting unique challenges and equipment to manipulate the candy's movement under gravity, offering an engaging and thoughtful experience."
              languages={["C++", "CMake"]}
          ...
          <Col md={4} className="project-card">
            <GenericCard
              ...
              description="FinTrack is a web application designed to help users manage their personal finances efficiently. It offers features for adding and categorizing expenses, setting, and tracking budgets, and visualizing financial data through graphs. The application also includes an admin page for managing categories and user accounts, streamlining the administration of financial tracking activities."
          ...
          <Col md={4} className="project-card">
            <GenericCard
              ...
              description="This project focuses on developing a web application that allows users to explore and discuss NASA's image gallery. Enabling user registration, login, and comments, the platform encourages space enthusiasts to collaboratively engage in conversations about captivating celestial images."
